...
const AndroidLarge4 = () => {
  ...
  return (
    <View style={[styles.androidLarge17, styles.androidBg]}>
      <View style={[styles.androidLarge16, styles.androidLayout1]}>
        <View style={[styles.androidLarge13Wrapper, styles.androidLayout1]}>
          <View style={[styles.androidLarge16, styles.androidLayout1]}>
            ...
            />
            <View
              style={[styles.androidLarge13Inner, styles.androidChildLayout8]}
            />
            ...
            <Image
              style={[styles.image12Icon, styles.addPosition]}
              contentFit="cover"
            ...
            <View
              style={[
                styles.androidLarge13Child8,
                styles.androidChildPosition5,
              ]}
            />
            ...
            <View
              style={[
                styles.androidLarge13Child9,
                styles.androidChildPosition4,
              ]}
            />
            ...
            <Image
              ...
              source={require("../assets/image-24.png")}
            />
            <Text style={[styles.vegBaos, styles.vegBaosPosition]}>
              Veg Baos
            </Text>
            ...
            />
            <Text style={[styles.petBottles, styles.waterTypo]}>
              Pet Bottles
            </Text>
            ...
            <View
              style={[
                styles.androidLarge13Child31,
                styles.androidChildPosition2,
              ]}
            />
            ...
            <View
              style={[
                styles.androidLarge13Child41,
                styles.androidChildPosition,
              ]}
            />
            <View
              style={[
                styles.androidLarge13Child42,
                styles.androidChildPosition,
              ]}
            />
            <Image
            ...
            />
            <Image
              style={[styles.androidLarge13Child43, styles.androidChildLayout8]}
              contentFit="cover"
              source={require("../assets/rectangle-541.png")}
            />
            <Text style={[styles.manchurian, styles.rsFlexBox]}>
              Manchurian
            </Text>
            <View
