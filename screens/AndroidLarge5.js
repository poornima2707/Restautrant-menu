...
const AndroidLarge5 = () => {
  ...
  return (
    <View style={[styles.androidLarge18, styles.androidBg]}>
      <View style={[styles.androidLarge13Wrapper, styles.androidLayout]}>
        <View style={[styles.androidLarge13, styles.androidLayout]}>
          ...
          <Image
            ...
            source={require("../assets/ellipse-12.png")}
          />
          <Text style={[styles.absAbsoluteBarbecues, styles.addTypo]}>
            AB’s Absolute Barbecues
          </Text>
          <Text style={styles.biryanibbqkebabnorthIn}>
            Biryani,BBQ,kebab,North in..
          </Text>
          <Text style={[styles.dharampethNagpur, styles.kRatingsTypo]}>
            Dharampeth Nagpur
          </Text>
          <Text style={[styles.kRatings, styles.textTypo]}>5k ratings</Text>
          ...
          />
          <Text style={styles.km}>3.1 km</Text>
          <Image
            style={[styles.androidLarge13Child7, styles.androidChildLayout4]}
            contentFit="cover"
          ...
          />
          <View
            style={[styles.androidLarge13Child14, styles.androidChildBorder1]}
          />
          <Image
          ...
          <View
            style={[styles.androidLarge13Child16, styles.androidChildBorder1]}
          />
          <Image
          ...
          />
          <Image
            style={[styles.image23Icon, styles.addPosition]}
            contentFit="cover"
          ...
          >
            <Text style={[styles.orderedNow1, styles.addTypo]}>
              Ordered Now
            </Text>
          </Pressable>
          <View
          ...
          />
          <Image
            style={[styles.androidLarge13Child38, styles.androidChildLayout4]}
            contentFit="cover"
          ...
          />
          <Text style={[styles.rs, styles.mealsTypo]}>370 RS</Text>
          <Image
            style={[styles.androidLarge13Child40, styles.androidPosition]}
            contentFit="cover"
            source={require("../assets/rectangle-371.png")}
          />
          <View
            style={[styles.androidLarge13Child41, styles.androidChildBorder]}
          />
          <Text style={[styles.add, styles.addPosition]}>ADD+</Text>
          <View
            style={[styles.androidLarge13Child42, styles.androidChildLayout]}
          />
          <Image
            style={[styles.androidLarge13Child43, styles.lineIconLayout]}
            contentFit="cover"
